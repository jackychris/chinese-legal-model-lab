...
| GRPO-200：required 行召回 | 35/42 | 39/42 | 改善，未达到 40/42 门槛 |
| GRPO-200：RAG 引用精度 | 0.7703 | 0.7874 | 改善 |
| GRPO-600：required 行召回 | 35/42 | 37/42 | 回吐 200 步改善 |
...
GRPO-200 把 required 行召回从 35/42 提高到 39/42，并且是本组实验中唯一同时提高 RAG 引用精度、保持整体语义分数地板的方法。它没有解决 no-context 切片上的稀疏奖励问题，也没有满足正常停止、重复和引用精度等全部门禁。
