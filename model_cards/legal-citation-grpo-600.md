...
dev84 的 required 行召回率由 Base 的 `83.33%` 变为 `88.10%`，低于 200 步的 `92.86%` 高水位；grounded citation precision 为 `77.36%`，仍远低于 `95%` 门禁。Legal-50 统一场均分为 Base `6.908`、200 步 `6.924`、600 步 `6.944`，差异远低于约 `0.4` 的可辨别尺度。
